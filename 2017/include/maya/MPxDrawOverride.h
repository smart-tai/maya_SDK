...
// ****************************************************************************
// CLASS DECLARATION (MPxDrawOverride2)

//! \ingroup OpenMayaRender MPx
//! \brief \obsolete
//! \brief Derived class of MPxDrawOverride to allow user overrided selection.
/*!
  \deprecated
  This virutal functions introduced with this class will be in MPxDrawOverride class in future releases.
...
*/
class OPENMAYARENDER_EXPORT MPxDrawOverride2 : public MPxDrawOverride
{
public:
	MPxDrawOverride2(
		const MObject& obj,
